...
class FirstTimeInstructionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionTextView.font = UIFont.HelveticaNeue()
    }
